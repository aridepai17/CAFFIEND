    ...
    <>
      ...
      <div className="card info-card">
        ...
        <p>
          ...
          still in your system, keeping you alert longer! So if you drink a cup
          of coffee with 200 mg of caffeine, 5 hours later, you&apos;ll still
          have about 100 mg of caffeine in your system.
        </p>
      </div>
    </>
  );
